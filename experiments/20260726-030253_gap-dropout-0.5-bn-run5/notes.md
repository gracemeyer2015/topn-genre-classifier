...
## Hypothesis
Repeat run of dropout 0.5 + batch norm, same settings as the other runs in this group,
...
## Result summary
Final val accuracy 65.8%, final train accuracy 66.7%,
gap +0.9 points. Final val loss 1.066.

## Interpretation
One data point in the repeated-trial comparison for dropout 0.5 + batch norm. See the
